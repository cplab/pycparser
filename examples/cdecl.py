...
# valid external declaration in C. All the types used in it must be defined
# with typedef, or parsing will fail. The definition can be arbitrary -
# pycparser doesn't really care what the type is defined to be, only that
# it's a type.
#
# For example:
#
